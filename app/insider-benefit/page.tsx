...
import { Copy, Share2, ChevronDown, Diamond, Gift, ChevronRight } from 'lucide-react'
...
export default function InsiderBenefitPage() {
      ...
      <div className="px-4 space-y-4">
        <div className="bg-zinc-900 rounded-xl p-4 flex items-center gap-4">
          <div className="w-12 h-12 flex items-center justify-center">
            <Diamond className="w-8 h-8 text-pink-500" />
          </div>
          <div>
        ...
        <div className="space-y-2 mb-4">
          ...
          <p className="text-sm text-pink-500">
            {activeReferrals >= 10 ? 
              ...
              `${tiers[1].min - activeReferrals} more sign up to reach the next tier!`
            }
          </p>
        </div>
                ...
                {referrals.map((referral, index) => (
                  ...
                  >
                    ...
                    <div className={`text-sm ${
                      referral.status === 'active' ? 'text-emerald-500' : 'text-zinc-400'
                    }`}>
